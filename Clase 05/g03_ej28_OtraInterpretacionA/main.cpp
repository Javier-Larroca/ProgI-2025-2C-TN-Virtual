...
int main()
{
    int nroCliente, nroSucursal, contUno=0, contDos=0, contTres=0, contCuatro=0, contUno20=0, contDos20=0, contTres20=0, contCuatro20=0;
    ...
    porcjUno = contUno/contUno20*100;
    porcjDos = contDos/contDos20*100;
    porcjTres = contTres/contTres20*100;
    porcjCuatro = contCuatro/contCuatro20*100;
